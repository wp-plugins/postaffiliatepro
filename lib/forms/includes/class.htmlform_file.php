...
class HTMLForm_file extends HTMLForm_control
{
     ...
     *
     *  @param  array   $attributes     (Optional) an array of user specified HTML attributes valid for an <input type="file>" control
     *
    ...
    function HTMLForm_file($controlID, $attributes = '')
    {
        ...
        $this->setAttributes(
            ...
            array(
                ...
                'name'      =>  $controlID,
                'class'     =>  'file',
                'onfocus'   =>  'this.className = \'file-focus\'',
                'onblur'    =>  'this.className = \'file\''
