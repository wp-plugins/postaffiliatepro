 ...
 */
class HTMLForm_submit extends HTMLForm_control
{
     ...
     *  {@*}
     *
     *  $obj = & $form->add('submit', 'control_id', 'Click to submit form');
     *
     *  </code>
     *
     ...
     *
     *  @param  array   $attributes     (Optional) an array of user specified HTML attributes valid for a submit button control
     *
     ...
     *  @return void
     */
    function HTMLForm_submit($controlID, $caption, $attributes = '')
    {
